const notificationsTypes = {
  ...
  newConversation: (data) => ({
    ...
    details: `<a href="/messages?id=${data[1]}#bottom">See new Conversation</a>`,
  }),
  newMessage: (data) => ({
    action: `${data[0]} has sent you a new message`,
    details: `<hr class="mb-2 mt-4"> <a href="/messages?id=${data[1]}#bottom">See new Message</a>`,
  ...
  changeConversationSettings: (data) => ({
    ...
    details: `Go check it out, it might conmpromise your privacy </br> <a href="/messages?id=${data[0]}#bottom">See the Conevrsation</a>`,
  }),
  deleteMessage: (data) => ({
    action: `${data[0]} has delete a message in a conversation with you`,
    details: `<a href="/messages?id=${data[1]}#bottom">See the Conversation</a>`,
  }),
